...
/**
 * models\Entities\MandatoryElearningCompletionRate
 *
 * @ORM\Table(name="mandatory_elearning_completion_rate")
 * @ORM\Entity
 */
class MandatoryElearningCompletionRate
{
    /**
     ...
     * @return MandatoryElearningCompletionRate
     */
