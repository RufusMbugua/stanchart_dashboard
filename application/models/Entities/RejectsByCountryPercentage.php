...
/**
 * models\Entities\RejectsByCountryPercentage
 *
 * @ORM\Table(name="rejects_by_country_percentage")
 * @ORM\Entity
 */
class RejectsByCountryPercentage
{
    /**
     ...
     * @return RejectsByCountryPercentage
     */
