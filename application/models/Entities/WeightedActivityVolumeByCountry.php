...
/**
 * models\Entities\WeightedActivityVolumeByCountry
 *
 * @ORM\Table(name="weighted_activity_volume_by_country")
 * @ORM\Entity
 */
class WeightedActivityVolumeByCountry
{
    /**
     ...
     * @return WeightedActivityVolumeByCountry
     */
