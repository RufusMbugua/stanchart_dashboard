...
/**
 * models\Entities\CountryHctByWeightedVolume
 *
 * @ORM\Table(name="country_hct_by_weighted_volume")
 * @ORM\Entity
 */
class CountryHctByWeightedVolume
{
    /**
     ...
     * @return CountryHctByWeightedVolume
     */
