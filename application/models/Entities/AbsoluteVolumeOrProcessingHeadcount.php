...
/**
 * models\Entities\AbsoluteVolumeOrProcessingHeadcount
 *
 * @ORM\Table(name="absolute_volume_or_processing_headcount")
 * @ORM\Entity
 */
class AbsoluteVolumeOrProcessingHeadcount
{
    /**
     ...
     * @return AbsoluteVolumeOrProcessingHeadcount
     */
