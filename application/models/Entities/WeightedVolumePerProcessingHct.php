...
/**
 * models\Entities\WeightedVolumePerProcessingHct
 *
 * @ORM\Table(name="weighted_volume_per_processing_hct")
 * @ORM\Entity
 */
class WeightedVolumePerProcessingHct
{
    /**
     ...
     * @return WeightedVolumePerProcessingHct
     */
