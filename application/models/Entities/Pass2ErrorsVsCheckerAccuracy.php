...
/**
 * models\Entities\Pass2ErrorsVsCheckerAccuracy
 *
 * @ORM\Table(name="pass2_errors_vs_checker_accuracy")
 * @ORM\Entity
 */
class Pass2ErrorsVsCheckerAccuracy
{
    /**
     ...
     * @return Pass2ErrorsVsCheckerAccuracy
     */
