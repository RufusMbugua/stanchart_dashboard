...
/**
 * models\Entities\CustomerComplaintsVsAccuracy
 *
 * @ORM\Table(name="customer_complaints_vs_accuracy")
 * @ORM\Entity
 */
class CustomerComplaintsVsAccuracy
{
    /**
     ...
     * @return CustomerComplaintsVsAccuracy
     */
