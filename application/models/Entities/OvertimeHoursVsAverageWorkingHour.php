...
/**
 * models\Entities\OvertimeHoursVsAverageWorkingHour
 *
 * @ORM\Table(name="overtime_hours_vs_average_working_hour")
 * @ORM\Entity
 */
class OvertimeHoursVsAverageWorkingHour
{
    /**
     ...
     * @return OvertimeHoursVsAverageWorkingHour
     */
