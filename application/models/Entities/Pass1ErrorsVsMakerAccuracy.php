...
/**
 * models\Entities\Pass1ErrorsVsMakerAccuracy
 *
 * @ORM\Table(name="pass1_errors_vs_maker_accuracy")
 * @ORM\Entity
 */
class Pass1ErrorsVsMakerAccuracy
{
    /**
     ...
     * @return Pass1ErrorsVsMakerAccuracy
     */
